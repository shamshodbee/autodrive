...
import { Menu, X, Car as CarIcon, LayoutGrid, PlusCircle, User, LogOut, ArrowLeftRight } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 text-xs font-semibold text-cool-200 hover:border-amber-500/40 hover:text-amber-500 transition-all"
            >
      ...
      {open && (
        <div className="md:hidden glass-strong border-t border-white/5 animate-fade-in">
          <div className="px-4 py-4 space-y-1">
            ...
            <button
              onClick={toggleCurrency}
              className="w-full flex items-center gap-2 px-4 py-3 rounded-lg text-sm font-medium text-cool-200 hover:bg-white/5"
            >
