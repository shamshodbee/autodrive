...
import { Car as CarIcon, Send, Instagram } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-cool-400">
            <a href="https://t.me/nshamshodbek_012" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors"><Send className="w-4 h-4" /></a>
            <a href="https://instagram.com/n.shamshodbek_012" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors"><Instagram className="w-4 h-4" /></a>
          </div>
        </div>
      </div>
    </footer>
