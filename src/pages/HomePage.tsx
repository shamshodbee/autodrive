...
import { CAR_CONDITION_LABELS, type CarCondition } from '../lib/types';
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-xs font-medium text-cool-300 flex items-center gap-1.5">
                      <SlidersHorizontal className="w-3.5 h-3.5" /> Narxi bo'yicha (max)
                    </label>
                  </div>
                  <input
                  ...
                  <input
                    ...
                    value={Math.min(maxPrice, 300000)}
                    onChange={(e) => setMaxPrice(Number(e.target.value))}
                    className="w-full"
                  />
                  <div className="flex justify-between text-[10px] text-cool-500 mt-1.5">
                    <span>10 ming$</span><span className="text-amber-500 font-medium">{format(maxPrice)}</span><span>300 ming$</span>
                  </div>
                </div>
