...
import {
  CAR_COLORS, CAR_CONDITIONS, CAR_CONDITION_LABELS, POPULAR_BRANDS, formatPrice,
...
export default function SellPage() {
  ...
  const [form, setForm] = useState({
    ...
    seller_phone: '', seller_telegram: '', seller_instagram: '',
  });
          ...
          <div className="space-y-5 animate-fade-in">
            <div>
              ...
              <p className="text-xs text-cool-500 mt-2">
                Hozir {formatPrice(form.price)} narx belgilangan. Xaridlar bilan savdolashishingiz mumkin.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-5 animate-fade-in">
            ...
            <div className="glass rounded-xl p-4 border border-white/5 mt-2">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                ...
                <div><span className="text-cool-400">Narxi:</span> <span className="text-amber-500 font-semibold">{formatPrice(form.price)}</span></div>
